...
$options = [
	...
	'disable_name_phone_registration'      => [
		'title'       => esc_html__( 'Hide Name and phone number', 'classified-listing' ),
		'type'        => 'checkbox',
		'description' => esc_html__( 'Hide Name and phone number at registration form', 'classified-listing' ),
	],
