...
use Rtcl\Traits\Functions\Core;
...
class Functions {
	...
	public static function get_favourites_link( $post_id ) {
		$button_class = apply_filters( 'rtcl_favourites_button_class', ' button ' );
	...
	public static function price( $price, $only_formatted_price = false, $args = [] ) {
		 ...
		 * @param float|string $original_price Original price as float, or empty string. Since 5.0.0.
		 */
		$price = apply_filters( 'formatted_rtcl_price', number_format( $price, $args['decimals'], $args['decimal_separator'], $args['thousand_separator'] ), $price, $args['decimals'], $args['decimal_separator'], $args['thousand_separator'], $original_price );
	...
	public static function is_enable_mark_as_sold() {
		...
		if ( rtcl()->has_pro() && method_exists( \RtclPro\Helpers\Fns::class, 'is_enable_mark_as_sold' ) ) {
			return \RtclPro\Helpers\Fns::is_enable_mark_as_sold();
		}
	...
	public static function get_base_location() {
		$default = apply_filters( 'rtcl_get_base_location', get_option( 'rtcl_default_country', 'US:CA' ) );

		return self::format_country_state_string( $default );
	}
	 ...
	 * @since 2.3.0
	 */
	public static function format_country_state_string( $country_string ) {
