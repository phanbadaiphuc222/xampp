...
class TemplateHooks {
	public static function init() {
		...
		// My listing actions
		add_action( 'rtcl_my_listing_actions', [ __CLASS__, 'my_listing_promotion_button' ], 10 );
	...
	public static function add_apply_filter_button() {
        ...
        <div class="ui-buttons has-expanded">
            <button
                    class="btn btn-primary rtcl-filter-btn"><?php echo esc_html__( "Apply filters", 'classified-listing' ); ?></button>
        </div>
		<?php
	}
