...
The Best WordPress Classified Ads and Business Directory Plugin to create Classified ads website, job directory, local business directory and service directory.
...
> [Click here to get Classima – Classified Ads WordPress Theme using Classified Listing Pro & Store plugin](https://1.envato.market/2944O)

> [Click here to get ClassiList – Classified ads WordPress Theme using Classified Listing Pro & Store plugin](https://www.radiustheme.com/downloads/classilist-classified-ads-wordpress-theme/)

> [Click here to get Mobile App – Classified ads iOS & Android mobile app](https://www.radiustheme.com/classified-listing-mobile-apps/)
...
== 🏆 Ad Control ==
This classified ads WordPress plugin gives you a choice between automatic and manual approval of your listings. If you have too many users, automatic approval is best. On the other hand, manually approving listings help screen ads in detail before posting them.
...
== 🚀 CORE CLASSIFIED LISTING FEATURES AT A GLANCE ==
...
== 🏆 Multiple Map Option ==
Location search is one of most important feature for Directory website as well as Classified ads website. Classified as plugin has multiple Map source. We included both Google Map and Open Street Map.
...
**OpenStreetMap**
OpenStreet Map is a free platform to display location and use the map features without Map API.

== 🏆 Radius Search ==
This plugin allows radius searches using Google place API & OpenStreet Map so that users can search for listings close to them.
...
👉 **[Custom Conditional Fields](https://www.radiustheme.com/docs/listing-management-admin/custom-fields/#conditional-fields):** You can create conditional fields. For instance, when you have car make, model, and year of release, the model depends on the make, while the year depends on the model.

👉 **MAP View:** The PRO version allows Map View using Google place API & OpenStreet Map. You can display your ads with Map. So that your can easily view the ads location wise in MAP.
...
05. User backend
06. Payment History
07. User account settings
08. GutenBerg Block List
09. GutenBerg Listing Block
10. Elementor Widget List
11. Elementor Listing Widget
...
= 2.2.3 ( April 20, 2022 ) =
* Added: Elementor listing widget custom Field control Added
...
* Fixed: Custom Field Checkbox Filter issue
